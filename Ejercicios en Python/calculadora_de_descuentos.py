...
num_producto = int(input("Digame cuantos productos son: ")) #preguntar la cantidad de productos
option = True   #inicializando option con valor True
...
while option != False:
    ...
    if descuento == 1: #descuento de 20%
    ...
    elif descuento == 2: #descuento de 50%
